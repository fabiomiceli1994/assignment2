...

{
  ...
  //checks that the parameters have been inserted consistently. If their size is different, exits
  ...
  //looping over every chosen mesh size / number of point in the interior of $[0, L]$
